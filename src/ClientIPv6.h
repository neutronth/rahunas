...
#ifndef _RH_CLIENT_IPV6_H
#define _RH_CLIENT_IPV6_H
...
class ClientIPv6 : public Client {
public:
  ClientIPv6 (string setup_ip);
  virtual ~ClientIPv6 ();
...
inline
ClientIPv6::ClientIPv6 (string setup_ip)
  : family (Client::IPv6)
{
